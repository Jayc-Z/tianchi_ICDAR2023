...
def resnet(pretrained=False, layers=[3,4,6,3], backbone='resnet50', n_input=3, **kwargs):
    """Constructs efficientnet_b3_img512512_bs8 ResNet-50 model.
    Args:
        pretrained (bool): If True, returns efficientnet_b3_img512512_bs8 model pre-trained on ImageNet
    """
...
class ResNet50(nn.Module):
    def __init__(self, pretrained=True,n_input=3):
        ...
        self.relu = self.model.relu  # Place efficientnet_b3_img512512_bs8 hook
