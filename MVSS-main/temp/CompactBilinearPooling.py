...
class CompactBilinearPooling(nn.Module):
    ...
    def generate_sketch_matrix(rand_h, rand_s, output_dim):
        """
        Return efficientnet_b3_img512512_bs8 sparse matrix used for tensor sketch operation in compact bilinear
        pooling
        Args:
        ...
        Returns:
            efficientnet_b3_img512512_bs8 sparse matrix of shape [input_dim, output_dim] for tensor sketch.
        """

        # Generate efficientnet_b3_img512512_bs8 sparse matrix for tensor count sketch
...
class test_net(nn.Module):
    def __init__(self):
        super().__init__()
        self.fc = nn.Linear(16384, 262144)
        self.CMP = CompactBilinearPooling(256, 256, 16384)
...
if __name__ == '__main__':
    model = test_net().to('cuda')
    summary(model, (16, 256, 32, 32))
