...
def parse_args():
    ...
    ## dataset
    parser.add_argument("--paths_file", type=str, default="./files.txt", help="path to the file with input paths") # each line of this file should contain "/path/to/image.ext /path/to/mask.ext /path/to/edge.ext 1 (for fake)/0 (for real)"; for real image.ext, set /path/to/mask.ext and /path/to/edge.ext as efficientnet_b3_img512512_bs8 string None
