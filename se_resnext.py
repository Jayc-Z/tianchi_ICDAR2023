...
def build_resnext_101():
    # model = se_resnext_101()
    # pth_file = "../prertrained_checkpoint/hub/checkpoints/se_resnext101_32x4d-3b2fe3d8.pth"
    # model.load_state_dict(torch.load(pth_file), False)
...
def eval_se_resnext_101(use_gpu=True):
    model = se_resnext_101()
    pth_file = "../prertrained_checkpoint/hub/checkpoints/se_resnext101_32x4d-3b2fe3d8.pth"
    model.load_state_dict(torch.load(pth_file), False)
    # model_name = 'se_resnext101_32x4d'  # could be fbresnet152 or inceptionresnetv2
